...
- The resulting short-lived GitHub App **user access token** is the appropriate credential for Workbench and `gh`: it acts as the user and spans the intersection of every installation and repository that both the user and App can access.

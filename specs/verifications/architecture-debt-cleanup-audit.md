...
- [x] **Test coverage** — 24 files / 297 tests pass. New regressions cover request-body limits, lifecycle timeout state, enqueue rollback, Incus metadata failure, repository path collisions, shared browser transport, and polling policy.
